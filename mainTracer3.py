...
def main():
	...
	middle1 = Sphere()
	middle1.transform = Transformations().translation(-0.5, -1, 0.5) * Transformations().scaling(0.5, 0.5, 0.5) * Transformations().shearing(1,2,3,4,5,6)
	middle1.material = Materials()
	middle1.material.color = Colors(0, 1, 1)
	middle1.material.diffuse = 0.7
	middle1.material.specular = 0.3
	
	right1 = Sphere()
	right1.transform = Transformations().translation(1.5, -0.5, -0.5) * Transformations().scaling(0.5, 0.5, 0.5) * Transformations().shearing(1,2,3,4,5,6)
	right1.material = Materials()
	right1.material.color = Colors(1, 1, 0)
	right1.material.diffuse = 0.7
	right1.material.specular = 0.3
	
	left1 = Sphere()
	left1.transform = Transformations().translation(-1.5, -0.33, -0.75) * Transformations().scaling(0.5, 0.5, 0.5) * Transformations().shearing(1,2,3,4,5,6)
	left1.material = Materials()
	left1.material.color = Colors(1, 0, 1)
	...
	world.objects.append(middle1)
	world.objects.append(right1)
	world.objects.append(left1)

	camera = Camera(1000, 600, math.pi/3)
